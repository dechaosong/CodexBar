...
- Codex: keep selected managed workspaces attached to their stacked usage rows instead of replacing them with the auth file's default workspace (#3347). Thanks @krevoit!
